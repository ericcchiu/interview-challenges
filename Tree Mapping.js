...
So map should return a tree with the same structure, and different values, but it should 
NOT modify the tree that was passed in.
*/



// Time complexity: Linear O(n), traverse every node, grows with input. 
...
console.log('Original Tree: ' + JSON.stringify(input));
console.log('Mapped Tree: ' + JSON.stringify(input.map(double)));
